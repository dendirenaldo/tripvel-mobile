...
import 'package:tripvel/page/form_bank.dart';
...
class _BankScreenState extends State<BankScreen> with AutomaticKeepAliveClientMixin<BankScreen> {
  @override
  ...
  Future<void> getBank() async {
    ...
    final response = await http.get(
      Uri.parse(
          '${dotenv.env['RESTFUL_API']}/bank-account?offset=${(page - 1) * limit}&limit=$limit&order=$order${cari.text != '' ? '&search=${cari.text}' : ''}'),
          ...
          tempBank.add(
            DataRow(
              cells: [
                ...
                DataCell(Text(data['namaBank'])),
                DataCell(Text(data['nomorRekening'].toString())),
                DataCell(Text(data['namaPemilik'])),
                DataCell(
                  IconButton(
                    ...
                    onPressed: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => FormBankPage(refresh: getBank, id: data['id']),
                      ),
                    ),
                  ),
                ),
                ...
                children: [
                  SizedBox(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text('Untuk melihat bank dengan lengkap, anda dapat menggeser ke kanan layar',
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            IconButton(onPressed: getBank, icon: const Icon(Icons.refresh_rounded))
                          ],
                        )
                      ],
                    ),
                  ...
                  SizedBox(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        IconButton(
                            onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => FormBankPage(refresh: getBank))),
